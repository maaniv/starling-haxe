...
class AnimationScene extends Scene
{
  ...
  private function onStartButtonTriggered():Void
  {
    ...
    Starling.juggler_().add(hideTween);
  }
  ...
  private function onDelayButtonTriggered():Void
  {
    ...
    Starling.juggler_().delayCall(colorizeEgg, 1.0, [true]);
    Starling.juggler_().delayCall(colorizeEgg, 2.0, [false]);
    Starling.juggler_().delayCall(function():Void
        {
