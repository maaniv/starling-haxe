...
class MeshStyle extends EventDispatcher
{
  ...
  private var _type:Class<Dynamic> = null;
  private var _target:Mesh = null;
  private var _texture:Texture = null;
  private var _textureBase:TextureBase = null;
  private var _textureSmoothing:String = null;
  private var _textureRepeat:Bool = false;
  private var _vertexData:VertexData = null;  // just a reference to the target's vertex data
  private var _indexData:IndexData = null;  // just a reference to the target's index data
