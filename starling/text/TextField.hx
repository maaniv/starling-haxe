...
class TextField extends DisplayObjectContainer
{
  ...
  private var _options:TextOptions = null;
  private var _format:TextFormat = null;
  private var _textBounds:Rectangle = null;
  private var _hitArea:Rectangle = null;
  private var _compositor:ITextCompositor = null;
  private var _requiresRecomposition:Bool = false;
  private var _border:DisplayObjectContainer = null;
  private var _meshBatch:MeshBatch = null;
  ...
  private function updateText():Void
  {
    ...
    _options.textureScale = Starling.contentScaleFactor_();
  ...
  public static function unregisterCompositor(name:String, dispose:Bool = true):Void
  {
    ...
    if (dispose && compositors[name] != null)
    {
  ...
  @:meta(Deprecated(replacement="registerCompositor"))
  ...
  @:meta(Deprecated(replacement="unregisterCompositor"))
  ...
  {
    var compos = getCompositor(name);
    if (compos == null) return null;
    if (!Std.is(compos, BitmapFont)) return null;
    return cast(compos, BitmapFont);
  }
  ...
  {
    var compositors:Map<String, ITextCompositor> = cast(Starling.painter_().sharedData[COMPOSITOR_DATA_NAME]);

    if (compositors == null)
    {
      compositors = new Map();
      Starling.painter_().sharedData[COMPOSITOR_DATA_NAME] = compositors;
    }
