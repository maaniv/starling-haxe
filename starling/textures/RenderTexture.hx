...
class RenderTexture extends SubTexture
{
  ...
  private var _activeTexture:Texture = null;
  private var _bufferTexture:Texture = null;
  private var _helperImage:Image = null;
  private var _drawing:Bool = false;
  private var _bufferReady:Bool = false;
  ...
  private static function set_useDoubleBuffering(value:Bool):Bool
  {
    ...
    {
      Starling.painter_().sharedData[USE_DOUBLE_BUFFERING_DATA_NAME] = value;
    }
    return value;
  }
}
