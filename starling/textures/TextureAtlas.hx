...
class TextureAtlas
{
  ...
  private var _atlasTexture:Texture = null;
  private var _subTextures:Map<String, SubTexture> = null;
  private var _subTextureNames:Vector<String> = null;
  ...
  private function parseAtlasXml(atlasXml:Xml):Void
  {
    ...
    var texture_atlas:Xml = atlasXml.elementsNamed("TextureAtlas").next();

    for (subTexture in texture_atlas.elementsNamed("SubTexture"))
    {
