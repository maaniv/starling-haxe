...
class CompositeEffect extends FilterEffect
{
  ...
  private var _layers:Vector<CompositeLayer> = null;

  private static var sLayers:Array<Dynamic> = new Array();
  ...
  private function getUsedLayers(out:Array<Dynamic> = null):Array<Dynamic>
  {
    ...
    for (layer/* AS3HX WARNING could not determine type for var: layer exp: EIdent(_layers) type: Vector<CompositeLayer> */ in _layers)
    {
