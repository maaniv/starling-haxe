...
class FragmentFilter extends EventDispatcher
{
  ...
  private var _quad:FilterQuad = null;
  private var _target:DisplayObject = null;
  private var _effect:FilterEffect = null;
  private var _vertexData:VertexData = null;
  private var _indexData:IndexData = null;
  private var _padding:Padding = null;
  private var _helper:FilterHelper = null;
  private var _resolution:Float = 0;
  private var _textureFormat:String = null;
  private var _textureSmoothing:String = null;
  private var _alwaysDrawToBackBuffer:Bool = false;
  private var _cacheRequested:Bool = false;
  private var _cached:Bool = false;

  // helpers
  private static var sMatrix3D:Matrix3D = null;
  ...
  private function renderPasses(painter:Painter, forCache:Bool):Void
  {
    ...
    else
    {
      ...
      {
        // normally, we don't need anything outside
        {
    ...
    if (!_quad.visible)
    {
      Pool.putRectangle(bounds);return;
    }
    ...
    _helper.textureScale = Starling.contentScaleFactor_() * _resolution;
