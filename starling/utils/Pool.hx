...
class Pool
{
  private static var sPoints:Vector<Point> = new Vector();
  private static var sPoints3D:Vector<Vector3D> = new Vector();
  private static var sMatrices:Vector<Matrix> = new Vector();
  private static var sMatrices3D:Vector<Matrix3D> = new Vector();
  private static var sRectangles:Vector<Rectangle> = new Vector();
