...
class RectangleUtil
{
  ...
  public static function fit(rectangle:Rectangle, into:Rectangle,
      scaleMode:String = ScaleMode.SHOW_ALL, pixelPerfect:Bool = false,
      out:Rectangle = null):Rectangle
  {
      ...
      camPos:Vector3D, out:Rectangle = null):Rectangle
  {
    ...
    // var minX:Float = as3hx.Compat.FLOAT_MAX;
    // var maxX:Float = -as3hx.Compat.FLOAT_MAX;
    // var minY:Float = as3hx.Compat.FLOAT_MAX;
    // var maxY:Float = -as3hx.Compat.FLOAT_MAX;
    var minX:Float = Math.POSITIVE_INFINITY;
    var maxX:Float = Math.NEGATIVE_INFINITY;
    var minY:Float = Math.POSITIVE_INFINITY;
    var maxY:Float = Math.NEGATIVE_INFINITY;
