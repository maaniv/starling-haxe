...
class MeshBatch extends Mesh
{
  ...
  private var _effect:MeshEffect = null;
  private var _batchable:Bool = false;
  private var _vertexSyncRequired:Bool = false;
  private var _indexSyncRequired:Bool = false;
