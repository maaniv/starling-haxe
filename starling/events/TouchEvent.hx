...
class TouchEvent extends Event
{
  ...
  private var _visitedObjects:Vector<EventDispatcher> = null;

  /** Helper object. */
  private static var sTouches:Vector<Touch> = new Vector();
  ...
  @:allow(starling.events)
  private function dispatch(chain:Vector<EventDispatcher>):Void
  {
  ...
  {
    var vec:Vector<Touch> = cast(data);
    return vec.concat();
  }
