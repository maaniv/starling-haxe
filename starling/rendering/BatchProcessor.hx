...
class BatchProcessor
{
  ...
  private var _batches:Vector<MeshBatch> = null;
  private var _batchPool:BatchPool = null;
  private var _currentBatch:MeshBatch = null;
  private var _currentStyleType:Class<Dynamic> = null;
  private var _onBatchComplete:Function = null;
  private var _cacheToken:BatchToken = null;
  ...
  private function set_onBatchComplete(value:Function):Function
  {
...
class BatchPool
{
  private var _batchLists:Map<String, Vector<MeshBatch>> = null;
  ...
  {
    var style_type_name = Type.getClassName(styleType);
    var batchList:Vector<MeshBatch> = _batchLists[style_type_name];
    if (batchList == null)
    {
      batchList = new Vector();
      _batchLists[style_type_name] = batchList;
    }
  ...
  {
    var style_type_name = Type.getClassName(meshBatch.style.type);
    var batchList:Vector<MeshBatch> = _batchLists[style_type_name];
    if (batchList == null)
    {
      batchList = new Vector();
...
class BatchPool
{
  private var _batchLists:Map<ClassKey, Vector<MeshBatch>>;
