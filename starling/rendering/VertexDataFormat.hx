...
{
  @:allow(starling.rendering) private var attributes(get, never):Vector<VertexDataAttribute>;
  ...
  public function setVertexBufferAt(index:Int, buffer:VertexBuffer3D, attrName:String):Void
  {
    ...
    Starling.context_().setVertexBufferAt(index, buffer, Std.int(attribute.offset / 4), attribute.format);
  }
